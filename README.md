...
- [x] **Phase 14** — Frontend dashboard: design system, app shell, Dashboard, Revenue at Risk, Case Detail (with human approve/reject), Recovery Cases, Escalations, Customers, Actions, and Analytics (charts) all complete and verified against live backend data. Remaining: Policies, Settings, and the audit trail backfill run.
