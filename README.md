...
- [x] **Phase 14 (in progress)** — Frontend dashboard: design system (dark instrument-panel aesthetic, "recovery pulse" signature motif), app shell (sidebar/topbar), and the Dashboard overview screen are complete and verified against live backend data. Remaining screens (Revenue at Risk, Recovery Cases, Analytics, Audit Trail, etc.) still in progress.
