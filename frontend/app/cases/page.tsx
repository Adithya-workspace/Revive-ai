            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-left text-xs font-medium text-text-faint uppercase tracking-wide">
                  ...
                  <th className="hidden sm:table-cell px-3 sm:px-5 py-3 text-right">Expected Value</th>
                  <th className="px-3 sm:px-5 py-3">Policy</th>
                  <th className="hidden md:table-cell px-3 sm:px-5 py-3">Execution</th>
              ...
              <tbody>
                {data.actions.map((a) => (
                  ...
                  >
                    ...
                    <td className="hidden sm:table-cell px-3 sm:px-5 py-3 text-right font-mono tabular-nums text-recovered whitespace-nowrap">
